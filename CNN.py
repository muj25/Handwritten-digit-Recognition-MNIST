...
class DigitRecognizerApp(customtkinter.CTk):
    def __init__(self):
        super().__init__()
        ...
        self.logo_label = customtkinter.CTkLabel(self.sidebar_frame, text="Digit Recognizer",
    ...
    def predict(self):
        ...
        for contour in contours:
            ...
            digit_img_resized = digit_img_resized.reshape(1, 28, 28, 1)

            # Predict
            pred = model.predict(digit_img_resized)[0]
